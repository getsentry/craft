...
url: "https://craft.sentry.dev/pr-preview/pr-854/targets/github/"
---
...
Coming soon: first-class workspaces
...
Declaring **multiple** `github` targets with **different** `tagPrefix` values in a _single_ config is currently ambiguous: Craft uses the first prefix for read-path operations and logs a warning. Until workspaces land, use a separate `.craft.yml` per product.
...
- [Parent: Targets Overview](https://craft.sentry.dev/pr-preview/pr-854/targets.md)
- [Previous: GitHub Pages](https://craft.sentry.dev/pr-preview/pr-854/targets/gh-pages.md)
- [Next: Hex](https://craft.sentry.dev/pr-preview/pr-854/targets/hex.md)
