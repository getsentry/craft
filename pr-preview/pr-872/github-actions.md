...
url: "https://craft.sentry.dev/pr-preview/pr-872/github-actions/"
---
...
Use `pull_request_target`, not `pull_request`
...
The version bump suggestion requires categories in your `.github/release.yml` to have `semver` fields defined. Without them, the suggested bump will show as “None”. See [Auto Mode configuration](/configuration/#auto-mode) for details.
...
- [Previous: Configuration](https://craft.sentry.dev/pr-preview/pr-872/configuration.md)
- [Next: Contributing](https://craft.sentry.dev/pr-preview/pr-872/contributing.md)
