...
url: "https://craft.sentry.dev/pr-preview/pr-863/configuration/"
---
...
This produces branches like `release/cli/1.2.3` and tags like `cli@1.2.3`. See the [GitHub target docs](https://craft.sentry.dev/pr-preview/pr-863/configuration/targets/github.md#monorepo-independently-versioned-products) for the full monorepo pattern.
...
- [Previous: Installation](https://craft.sentry.dev/pr-preview/pr-863/getting-started.md)
- [Next: GitHub Actions](https://craft.sentry.dev/pr-preview/pr-863/github-actions.md)
