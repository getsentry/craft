...
| `sdks.sdkIdentifier`            | **optional** SDK identifier name. Used when the package is not registered in the release registry yet.                                                                                                                                     |
| `(sdks\|apps).manifestTemplate` | **optional** Path to the initial manifest file. Used when the package is not registered in the release registry yet.                                                                                                                       |
