...
url: "https://craft.sentry.dev/github-actions/"
---
...
The version bump suggestion requires categories in your `.github/release.yml` to have `semver` fields defined. Without them, the suggested bump will show as “None”. See [Auto Mode configuration](https://craft.sentry.dev/configuration.md#auto-mode) for details.
...
- [Previous: Configuration](https://craft.sentry.dev/configuration.md)
- [Next: Contributing](https://craft.sentry.dev/contributing.md)
